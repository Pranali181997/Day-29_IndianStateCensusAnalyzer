...
namespace CensusAnalyserTest
{
    public class Tests
    {
        ...
        static string indianStateCensusFilePath = @"C:\Users\Admin\source\repos\BATCH 111\CensusAnalyserTest\CSVFiles\IndiaStateCensusData - IndiaStateCensusData.csv";
        //file path for indian state code csv file
        static string indianStateCodeFilePath = @"C:\Users\Admin\source\repos\BATCH 111\CensusAnalyserTest\CSVFiles\IndiaStateCode - IndiaStateCode.csv";
        //file path for wrong header csv file
        static string wrongHeaderIndianStateCensusFilePath = @"C:\Users\Admin\source\repos\BATCH 111\CensusAnalyserTest\CSVFiles\WrongIndiaStateCensusData - WrongIndiaStateCensusData.csv";
        //file path for wrong header csv file
        static string wrongHeaderIndianStateCodeFilePath = @"C:\Users\Admin\source\repos\BATCH 111\CensusAnalyserTest\CSVFiles\WrongIndiaStateCensusData - WrongIndiaStateCensusData.csv";
        //file path for wrong delimitercsv file
        static string wrongDelimiterIndianStateCensusFilePath = @"C:\Users\Admin\source\repos\BATCH 111\CensusAnalyserTest\CSVFiles\sDelimiterIndiaStateCensusData - DelimiterIndiaStateCensusData.csv";
        //file path for wrong delimeter csv file
        static string wrongDelimiterIndianStateCodeFilePath = @"C:\Users\Admin\source\repos\BATCH 111\CensusAnalyserTest\CSVFiles\DelimiterIndiaStateCode - DelimiterIndiaStateCode.csv";
        //file path for wrong state census csv file
        static string wrongIndianStateCensusFilePath = @"C:\Users\Admin\source\repos\BATCH 111\CensusAnalyserTest\CSVFiles1\WrongIndiaStateCensusData - WrongIndiaStateCensusData";
        //file path for wrong state code csv file
        static string wrongIndianStateCodeFilePath = @"C:\Users\Admin\source\repos\BATCH 111\CensusAnalyserTest\CSVFiles\WrongIndiaStateCode - WrongIndiaStateCode.csv";
        //file path for wrong state file type
        static string wrongIndianStateCensusFileType = @"C:\Users\Admin\source\repos\BATCH 111\CensusAnalyserTest\CSVFiles\IndiaStateCode.txt";
        //file path for wrong state code file type
        static string wrongIndianStateCodeFileType = @"C:\Users\Admin\source\repos\BATCH 111\CensusAnalyserTest\CSVFiles\IndiaStateCode.txt";
